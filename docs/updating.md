...
To import the changes made to the *Oro Docker* template into your project, we recommend using
...
1. Run the script to synchronize your project with the latest version of the skeleton:
    ...
    ```console
    curl -sSL https://raw.githubusercontent.com/mano-lis/template-sync/main/template-sync.sh | sh -s -- https://github.com/Dylvn/oro-docker
    ```
